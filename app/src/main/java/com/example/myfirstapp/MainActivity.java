...
public class MainActivity extends Activity implements Button.OnClickListener{
    ...
    private void initView() {
        ...
        //获取当前周数
        week = c.get(Calendar.WEEK_OF_YEAR) - 9;
        //获取当前星期几
        ...
        if(dayOfWeek == 1){
            if((houre == 8 && minute >= 30) || houre == 9 || (houre == 10 && minute <= 5)){
                ...
                if(bt_class.getText().toString().isEmpty()){
                    Toast.makeText(this, "周一第一节没课", Toast.LENGTH_LONG).show();
                }else{
                    Toast.makeText(this, "周一第一节课是" + bt_class.getText().toString(), Toast.LENGTH_LONG).show();
                }
            }else if((houre == 10 && minute >= 25) || houre == 11 || (houre == 12 && minute <= 0)){
                bt_class = (Button)findViewById(R.id.button8);
                if(bt_class.getText().toString().isEmpty()){
                    Toast.makeText(this, "周一第二节没课", Toast.LENGTH_LONG).show();
                }else{
                    Toast.makeText(this, "周一第二节课是" + bt_class.getText().toString(), Toast.LENGTH_LONG).show();
                }
            }else if((houre == 13 && minute >= 30) || houre == 14 || (houre == 15 && minute <= 5)){
                bt_class = (Button)findViewById(R.id.button15);
                if(bt_class.getText().toString().isEmpty()){
                    Toast.makeText(this, "周一第三节没课", Toast.LENGTH_LONG).show();
                }else{
                    Toast.makeText(this, "周一第三节课是" + bt_class.getText().toString(), Toast.LENGTH_LONG).show();
                }
            }else if((houre == 15 && minute >= 25) || houre == 16 || (houre == 17 && minute <= 0)){
                bt_class = (Button)findViewById(R.id.button22);
                if(bt_class.getText().toString().isEmpty()){
                    Toast.makeText(this, "周一第四节没课", Toast.LENGTH_LONG).show();
                }else{
                    Toast.makeText(this, "周一第四节课是" + bt_class.getText().toString(), Toast.LENGTH_LONG).show();
                }
            }else{
            ...
            if((houre == 8 && minute >= 30) || houre == 9 || (houre == 10 && minute <= 5)){
                ...
                if(bt_class.getText().toString().isEmpty()){
                    Toast.makeText(this, "周二第一节没课", Toast.LENGTH_LONG).show();
                }else{
                    Toast.makeText(this, "周二第一节课是" + bt_class.getText().toString(), Toast.LENGTH_LONG).show();
                }
            }else if((houre == 10 && minute >= 25) || houre == 11 || (houre == 12 && minute <= 0)){
                bt_class = (Button)findViewById(R.id.button9);
                if(bt_class.getText().toString().isEmpty()){
                    Toast.makeText(this, "周二第二节没课", Toast.LENGTH_LONG).show();
                }else{
                    Toast.makeText(this, "周二第二节课是" + bt_class.getText().toString(), Toast.LENGTH_LONG).show();
                }
            }else if((houre == 13 && minute >= 30) || houre == 14 || (houre == 15 && minute <= 5)){
                bt_class = (Button)findViewById(R.id.button16);
                if(bt_class.getText().toString().isEmpty()){
                    Toast.makeText(this, "周二第三节没课", Toast.LENGTH_LONG).show();
                }else{
                    Toast.makeText(this, "周二第三节课是" + bt_class.getText().toString(), Toast.LENGTH_LONG).show();
                }
            }else if((houre == 15 && minute >= 25) || houre == 16 || (houre == 17 && minute <= 0)){
                bt_class = (Button)findViewById(R.id.button23);
                if(bt_class.getText().toString().isEmpty()){
                    Toast.makeText(this, "周二第四节没课", Toast.LENGTH_LONG).show();
                }else{
                    Toast.makeText(this, "周二第四节课是" + bt_class.getText().toString(), Toast.LENGTH_LONG).show();
                }
            }else{
                Toast.makeText(this, "非上课时间", Toast.LENGTH_LONG).show();
            }
            ...
            if((houre == 8 && minute >= 30) || houre == 9 || (houre == 10 && minute <= 5)){
                ...
                if(bt_class.getText().toString().isEmpty()){
                    Toast.makeText(this, "周三第一节没课", Toast.LENGTH_LONG).show();
                }else{
                    Toast.makeText(this, "周三第一节课是" + bt_class.getText().toString(), Toast.LENGTH_LONG).show();
                }
            }else if((houre == 10 && minute >= 25) || houre == 11 || (houre == 12 && minute <= 0)){
                bt_class = (Button)findViewById(R.id.button10);
                if(bt_class.getText().toString().isEmpty()){
                    Toast.makeText(this, "周三第二节没课", Toast.LENGTH_LONG).show();
                }else{
                    Toast.makeText(this, "周三第二节课是" + bt_class.getText().toString(), Toast.LENGTH_LONG).show();
                }
            }else if((houre == 13 && minute >= 30) || houre == 14 || (houre == 15 && minute <= 5)){
                bt_class = (Button)findViewById(R.id.button17);
                if(bt_class.getText().toString().isEmpty()){
                    Toast.makeText(this, "周三第三节没课", Toast.LENGTH_LONG).show();
                }else{
                    Toast.makeText(this, "周三第三节课是" + bt_class.getText().toString(), Toast.LENGTH_LONG).show();
                }
            }else if((houre == 15 && minute >= 25) || houre == 16 || (houre == 17 && minute <= 0)){
                bt_class = (Button)findViewById(R.id.button24);
                if(bt_class.getText().toString().isEmpty()){
                    Toast.makeText(this, "周三第四节没课", Toast.LENGTH_LONG).show();
                }else{
                    Toast.makeText(this, "周三第四节课是" + bt_class.getText().toString(), Toast.LENGTH_LONG).show();
                }
            }else{
                Toast.makeText(this, "非上课时间", Toast.LENGTH_LONG).show();
            }
            ...
            if((houre == 8 && minute >= 30) || houre == 9 || (houre == 10 && minute <= 5)){
                ...
                if(bt_class.getText().toString().isEmpty()){
                    Toast.makeText(this, "周四第一节没课", Toast.LENGTH_LONG).show();
                }else{
                    Toast.makeText(this, "周四第一节课是" + bt_class.getText().toString(), Toast.LENGTH_LONG).show();
                }
            }else if((houre == 10 && minute >= 25) || houre == 11 || (houre == 12 && minute <= 0)){
                bt_class = (Button)findViewById(R.id.button11);
                if(bt_class.getText().toString().isEmpty()){
                    Toast.makeText(this, "周四第二节没课", Toast.LENGTH_LONG).show();
                }else{
                    Toast.makeText(this, "周四第二节课是" + bt_class.getText().toString(), Toast.LENGTH_LONG).show();
                }
            }else if((houre == 13 && minute >= 30) || houre == 14 || (houre == 15 && minute <= 5)){
                bt_class = (Button)findViewById(R.id.button18);
                if(bt_class.getText().toString().isEmpty()){
                    Toast.makeText(this, "周四第三节没课", Toast.LENGTH_LONG).show();
                }else{
                    Toast.makeText(this, "周四第三节课是" + bt_class.getText().toString(), Toast.LENGTH_LONG).show();
                }
            }else if((houre == 15 && minute >= 25) || houre == 16 || (houre == 17 && minute <= 0)){
                bt_class = (Button)findViewById(R.id.button25);
                if(bt_class.getText().toString().isEmpty()){
                    Toast.makeText(this, "周四第四节没课", Toast.LENGTH_LONG).show();
                }else{
                    Toast.makeText(this, "周四第四节课是" + bt_class.getText().toString(), Toast.LENGTH_LONG).show();
                }
            }else{
                Toast.makeText(this, "非上课时间", Toast.LENGTH_LONG).show();
            }
            ...
            if((houre == 8 && minute >= 30) || houre == 9 || (houre == 10 && minute <= 5)){
                ...
                if(bt_class.getText().toString().isEmpty()){
                    Toast.makeText(this, "周五第一节没课", Toast.LENGTH_LONG).show();
                }else{
                    Toast.makeText(this, "周五第一节课是" + bt_class.getText().toString(), Toast.LENGTH_LONG).show();
                }
            }else if((houre == 10 && minute >= 25) || houre == 11 || (houre == 12 && minute <= 0)){
                bt_class = (Button)findViewById(R.id.button12);
                if(bt_class.getText().toString().isEmpty()){
                    Toast.makeText(this, "周五第二节没课", Toast.LENGTH_LONG).show();
                }else{
                    Toast.makeText(this, "周五第二节课是" + bt_class.getText().toString(), Toast.LENGTH_LONG).show();
                }
            }else if((houre == 13 && minute >= 30) || houre == 14 || (houre == 15 && minute <= 5)){
                bt_class = (Button)findViewById(R.id.button19);
                if(bt_class.getText().toString().isEmpty()){
                    Toast.makeText(this, "周五第三节没课", Toast.LENGTH_LONG).show();
                }else{
                    Toast.makeText(this, "周五第三节课是" + bt_class.getText().toString(), Toast.LENGTH_LONG).show();
                }
            }else if((houre == 15 && minute >= 25) || houre == 16 || (houre == 17 && minute <= 0)){
                bt_class = (Button)findViewById(R.id.button26);
                if(bt_class.getText().toString().isEmpty()){
                    Toast.makeText(this, "周五第四节没课", Toast.LENGTH_LONG).show();
                }else{
                    Toast.makeText(this, "周五第四节课是" + bt_class.getText().toString(), Toast.LENGTH_LONG).show();
                }
            }else{
                Toast.makeText(this, "非上课时间", Toast.LENGTH_LONG).show();
            }
            ...
            if((houre == 8 && minute >= 30) || houre == 9 || (houre == 10 && minute <= 5)){
                ...
                if(bt_class.getText().toString().isEmpty()){
                    Toast.makeText(this, "周六第一节没课", Toast.LENGTH_LONG).show();
                }else{
                    Toast.makeText(this, "周六第一节课是" + bt_class.getText().toString(), Toast.LENGTH_LONG).show();
                }
            }else if((houre == 10 && minute >= 25) || houre == 11 || (houre == 12 && minute <= 0)){
                bt_class = (Button)findViewById(R.id.button13);
                if(bt_class.getText().toString().isEmpty()){
                    Toast.makeText(this, "周六第二节没课", Toast.LENGTH_LONG).show();
                }else{
                    Toast.makeText(this, "周六第二节课是" + bt_class.getText().toString(), Toast.LENGTH_LONG).show();
                }
            }else if((houre == 13 && minute >= 30) || houre == 14 || (houre == 15 && minute <= 5)){
                bt_class = (Button)findViewById(R.id.button20);
                if(bt_class.getText().toString().isEmpty()){
                    Toast.makeText(this, "周六第三节没课", Toast.LENGTH_LONG).show();
                }else{
                    Toast.makeText(this, "周六第三节课是" + bt_class.getText().toString(), Toast.LENGTH_LONG).show();
                }
            }else if((houre == 15 && minute >= 25) || houre == 16 || (houre == 17 && minute <= 0)){
                bt_class = (Button)findViewById(R.id.button27);
                if(bt_class.getText().toString().isEmpty()){
                    Toast.makeText(this, "周六第四节没课", Toast.LENGTH_LONG).show();
                }else{
                    Toast.makeText(this, "周六第四节课是" + bt_class.getText().toString(), Toast.LENGTH_LONG).show();
                }
            }else{
                Toast.makeText(this, "非上课时间", Toast.LENGTH_LONG).show();
            }
            ...
            if((houre == 8 && minute >= 30) || houre == 9 || (houre == 10 && minute <= 5)){
                ...
                if(bt_class.getText().toString().isEmpty()){
                    Toast.makeText(this, "周日第一节没课", Toast.LENGTH_LONG).show();
                }else{
                    Toast.makeText(this, "周日第一节课是" + bt_class.getText().toString(), Toast.LENGTH_LONG).show();
                }
            }else if((houre == 10 && minute >= 25) || houre == 11 || (houre == 12 && minute <= 0)){
                bt_class = (Button)findViewById(R.id.button14);
                if(bt_class.getText().toString().isEmpty()){
                    Toast.makeText(this, "周日第二节没课", Toast.LENGTH_LONG).show();
                }else{
                    Toast.makeText(this, "周日第二节课是" + bt_class.getText().toString(), Toast.LENGTH_LONG).show();
                }
            }else if((houre == 13 && minute >= 30) || houre == 14 || (houre == 15 && minute <= 5)){
                bt_class = (Button)findViewById(R.id.button21);
                if(bt_class.getText().toString().isEmpty()){
                    Toast.makeText(this, "周日第三节没课", Toast.LENGTH_LONG).show();
                }else{
                    Toast.makeText(this, "周日第三节课是" + bt_class.getText().toString(), Toast.LENGTH_LONG).show();
                }
            }else if((houre == 15 && minute >= 25) || houre == 16 || (houre == 17 && minute <= 0)){
                bt_class = (Button)findViewById(R.id.button28);
                if(bt_class.getText().toString().isEmpty()){
                    Toast.makeText(this, "周日第四节没课", Toast.LENGTH_LONG).show();
                }else{
                    Toast.makeText(this, "周日第四节课是" + bt_class.getText().toString(), Toast.LENGTH_LONG).show();
                }
            }else{
                Toast.makeText(this, "非上课时间", Toast.LENGTH_LONG).show();
            }
